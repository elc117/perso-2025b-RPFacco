...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{historico: _List_Nil, jogoAtivo: true, palpite: ''},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$RecebeNova = function (a) {
	return {$: 'RecebeNova', a: a};
};
...
var $author$project$Main$AtualizarPalpite = function (a) {
	return {$: 'AtualizarPalpite', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Termo em Haskell (Elm)')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$NovaPartida)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Nova Partida')
					])),
				A2(
				$elm$html$Html$form,
				_List_fromArray(
					[
						$elm$html$Html$Events$onSubmit($author$project$Main$Enviar)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('Digite aqui'),
								$elm$html$Html$Attributes$value(model.palpite),
								$elm$html$Html$Events$onInput($author$project$Main$AtualizarPalpite),
								$elm$html$Html$Attributes$disabled(!model.jogoAtivo)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$button,
